 ...
 *
 * "Matryoshka" this is joke, it's alias for wrappers,
...
use Matryoshka\Assigns\Destination;
use Matryoshka\Assigns\Flags;
use Matryoshka\Assigns\RcloneException;
use Matryoshka\Assigns\Source;
...
class Rclone
{
    ...
    public function setFlags(Flags $oFlags)
    {
        $this->oFlags = $oFlags;
        return $this;
    }
